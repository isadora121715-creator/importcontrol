...
const Valvulas = () => {
  ...
  const statusOptions = useMemo(() => {
    if (activeCategory === "Válvulas") return VALVULAS_STATUS_OPTIONS;
    const set = new Set<string>();
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-[1600px] p-6 space-y-8">
        <SupplierTicker items={tickerItems} label="FORNECEDORES — VÁLVULAS" />
        {/* View Tabs */}
              ...
              <div className="flex-1 min-w-0 space-y-6">
                <div className="flex flex-col sm:flex-row sm:items-center gap-2 rounded-lg border bg-card p-3 shadow-sm">
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    <button
                      onClick={() => {
                        const ok = downloadValvulasDashboard(filteredData as any, activeCategory);
